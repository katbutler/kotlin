...
private var Application.isScriptDependenciesUpdaterDisabled: Boolean? by UserDataProperty(Key.create("SCRIPT_DEPENDENCIES_UPDATER_DISABLED"))

@TestOnly
fun disableScriptDependenciesUpdater() {
    ApplicationManager.getApplication().isScriptDependenciesUpdaterDisabled = true
}

@TestOnly
fun enableScriptDependenciesUpdate() {
    ApplicationManager.getApplication().isScriptDependenciesUpdaterDisabled = null
}